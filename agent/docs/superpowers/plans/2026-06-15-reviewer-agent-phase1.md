...
- **Still deferred (needs Anthropic credits):** LLM end-to-end smoke. **Future refinements:** full common/ severance (middleware + read-only tools), /reviews dashboard, cron automation, trace ingestion.
