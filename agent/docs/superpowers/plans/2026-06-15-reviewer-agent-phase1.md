...
- **Future refinements:** full common/ severance (middleware + read-only tools), /reviews dashboard, cron automation, trace ingestion, seed local Supabase (or apply migrations to cloud) for a data-rich reviewer run.
